...
SELECT USERNAME, PASSWORD_HASH FROM ALUMNO;
UPDATE ALUMNO 
SET PASSWORD_HASH = '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'
WHERE USERNAME = 'nikola.tesla';
SELECT * FROM matricula;
ALTER TABLE MATRICULA 
CHANGE ANIO_ESCOLAR FECHA_ESCOLAR YEAR NOT NULL;
SELECT * FROM matricula;
...
SELECT ID_ALUMNO, NOMBRES, APELLIDOS, USERNAME FROM ALUMNO;
SELECT * FROM MATRICULA;