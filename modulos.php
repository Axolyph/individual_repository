...
<body>
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="#" data-module="matriculas"><i class="fa-solid fa-file-contract"></i>Matrículas</a></li>
                    <li><a href="#" data-module="pagos"><i class="fa-solid fa-money-bill-wave"></i>Pagos</a></li>
                    <li><a href="#" data-module="configuracion"><i class="fa-solid fa-gear"></i>Configuración</a></li>
                </ul>
            </nav>
    ...
    <div class="dropdown-menu-custom" id="dropdownMenu">
        ...
        <a class="dropdown-item-custom danger" onclick="cerrarSesion()">
            ...
            <!-- ========== MODULO DASHBOARD ========== -->
            <div id="modulo-dashboard" class="modulo" style="display: none;">
            ...
            <!-- ========== MODULO ESTUDIANTES ========== -->
            <div id="modulo-estudiantes" class="modulo active">
                <div class="content-body">
                    <div class="card table-card">
                        <div class="card-header">
                            ...
                            <div class="config-body">
                                <div class="config-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telefono" name="telefono" placeholder="988111223" maxlength="9">
                                    </div>
                                </div>
                            </div>
