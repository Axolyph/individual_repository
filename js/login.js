$(document).ready(function () {
  $("#loginForm").submit(function (evento) {
    //Esta funcion evita el parpadeo o recarga de pantalla
    evento.preventDefault();

    //Capturamos los datos ingresados por el usario
    //en una variable.
    let usuario = $("#logUsuario").val();
      ...
      success: function (respuesta) {
        if (respuesta.exito) {
          ...
          Swal.fire({
            ...
            window.location.href = "php/logindashboard.php";
          });
        } else {
