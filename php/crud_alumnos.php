...
// Recibir qué acción queremos hacer (1: Crear, 2: Editar, 3:Eliminar)
    ...
    $sql = "INSERT INTO ALUMNO (DNI_ALUMNO, NOMBRES, APELLIDOS,
    FECHA_NACIMIENTO, EDAD, GENERO, DIRECCION, CELULAR, CORREO,
    NOMBRE_APODERADO, CELULAR_APODERADO, USERNAME, PASSWORD_HASH, ESTADO)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([
    $_POST['dni'], $_POST['nombres'], $_POST['apellidos'],
    $_POST['fecha_nac'], $_POST['edad'], $_POST['genero'],
    $_POST['direccion'], $_POST['celular'], $_POST['correo'],
    $_POST['apoderado'], $_POST['cel_apoderado'], $_POST['username'], $hash,
    $_POST['estado']  // 👈 esto se agrega
]);
...
break;
    ...
    if(!empty($_POST['password'])){$hash = password_hash($_POST['password'],PASSWORD_DEFAULT);
    ...
    $params = [$_POST['dni'], $_POST['nombres'],
    $_POST['apellidos'], $_POST['fecha_nac'], $_POST['edad'],
    $_POST['genero'], $_POST['direccion'], $_POST['celular'],
    $_POST['correo'], $_POST['apoderado'], $_POST['cel_apoderado'],
    $_POST['username'], $_POST['estado'], $_POST['id_alumno']];
    ...
    $_POST['genero'], $_POST['direccion'], $_POST['celular'],
    $_POST['correo'], $_POST['apoderado'], $_POST['cel_apoderado'],
    $_POST['username'], $_POST['id_alumno']];
...
case '3': // ELIMINAR REGISTRO
    ...
    echo json_encode(["exito" => true, "mensaje" => "Registro
    ...
    break;
    default:
    echo json_encode(["exito" => false, "mensaje" => "Opción no
